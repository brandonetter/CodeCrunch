...
export const createORM = function (data) {
  console.log(data);
  var orm = {};
  var findBy = function (model, key, value) {
    return data[model].find(function (item) {
    ...
    return Object.keys(includeQuery).reduce(function (acc, key) {
      ...
      if (nestedInclude) {
        ...
        if (typeof nestedInclude === "boolean") {
          includeData = filterBy(
            key,
            ((_a = {}), (_a["".concat(modelMin, "Id")] = data.id), _a)
          );
        } else {
          ...
          includeData = filterBy(
            key,
            __assign(
              __assign({}, whereClause),
              ((_b = {}), (_b["".concat(modelMin, "Id")] = data.id), _b)
            )
          );
        }
  ...
  var handleInclude = function (model, data, includeQuery) {
    ...
    if (typeof includeQuery !== "boolean") {
      if (
        includeQuery === null || includeQuery === void 0
          ? void 0
